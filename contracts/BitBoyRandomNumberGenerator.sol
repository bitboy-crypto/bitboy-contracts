...
contract BitBoyRandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    using SafeERC20 for IERC20;

    address public bitBoyLottery;
     ...
     * @param _seed: seed provided by the BitBoylottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == bitBoyLottery, "Only BitBoyLottery");
    ...
    /**
     * @notice Set the address for the BitBoyLottery
     * @param _bitBoyLottery: address of the BitBoylottery
     */
    function setLotteryAddress(address _bitBoyLottery) external onlyOwner {
        bitBoyLottery = _bitBoyLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBitBoyLottery(bitBoyLottery).viewCurrentLotteryId();
    }
}
